...
spacing="2"    
>
        <Button onClick={()=>setCaseSelected('createDag')}> Create a DAG - Merkle Directed Acyclic Graphs </Button>  
        <Button onClick={()=>setCaseSelected('getFromIpfsModal')}> Get a unique Content Identifier (CID). </Button>  
        <Button onClick={()=>setCaseSelected('getFileIpfsModal')}> Get a file from a Content Identifier. </Button>  
        <Button onClick={()=>setCaseSelected('addIpfsModal')}> Add a file to a Local IPFS node  and query it locally. </Button>  
        <Button onClick={()=>setCaseSelected('cidModal')}> Already have a Content Identifier hash? Paste it here: </Button>  
        </Stack>    
<br/>               
        <Divider />    
<br/>               
