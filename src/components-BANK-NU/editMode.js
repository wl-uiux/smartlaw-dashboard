...
<Text> Writable: {canWrite(db)?'yes':'no'} </Text>  
        </TableCaption>    
        <Thead>    
        <Tr>    
{db._type === 'eventlog'?    
...
:    
        <Center>    
<Text>no entries or DB not synchronized.. <Link href='https://www.youtube.com/watch?v=MkoeqtKUUe4' target='_blank' rel='noreferrer' style={{color:'white'}}>be patient or retry later</Link><    
/Text>  
        </Center>}    
        </div>    
}
