...
Our Story   
         ...
         <Heading> A digital engineering consulting business. </Heading>  
...
borderColor={useColorModeValue('gray.100', 'gray.700')}    
 />
         ...
         <Feature    
icon={    
<Icon as={ IoAnalyticsSharp } w={5} h={5} color='yellow.500'/>  
 }
...
text={' Financial Planning '}  
 />
         <Feature    
icon={    
<Icon as={ IoSearchSharp } w={5} h={5} color='purple.500' />  
 }
