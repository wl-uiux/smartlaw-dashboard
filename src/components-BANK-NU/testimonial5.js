...
{title}    
      ...
      function Testimonial5() {      
       return (     
        ...
        <Heading> LexDAO Clients  </Heading>  
<Text> Three LexDAO provides value and service supporting the fourth industrial revolution. Web3 is a set of technologies that publicly interoperate through blockchain and node based computing systems. </Text>  
        </Stack>    
        <Stack    
