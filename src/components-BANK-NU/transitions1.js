...
<br/>               
        <Box>    
        <HStack>    
        <Button variant="outline" colorScheme="cyan" onClick={onToggle}> Click Me </Button>  
        <Fade in={isOpen}>    
        <Box    
p="40px"    
color="white"    
...
>
  FadeIn Box          
        ...
        <Button variant="outline" colorScheme="orange" onClick={onToggle}> Click Me </Button>  
